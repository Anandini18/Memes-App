...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var internetBtn : Button
    lateinit var memeImageView: ImageView
    lateinit var progressBar: ProgressBar
    lateinit var shareButton: Button
    lateinit var nextButton: Button
    lateinit var main_bg : ConstraintLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_main)
                ...
                internetBtn=findViewById(R.id.button)
            ...
            Glide.with(this).load(currentImageUrl).listener(object : RequestListener<Drawable>
            {
                ...
                override fun onResourceReady(
                    ...
                    Palette.from(resource!!.toBitmap()).generate(){
                        pallete->pallete?.let{
                            val intColor=it.lightVibrantSwatch?.rgb?:0
                        main_bg.setBackgroundColor(intColor)
                            val intColor1=it.darkMutedSwatch?.rgb?:0
                        shareButton.setBackgroundColor(intColor1)
                        nextButton.setBackgroundColor(intColor1)
                    }
                    }
                    return false
                }
